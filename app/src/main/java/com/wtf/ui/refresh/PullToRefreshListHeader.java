...
public class PullToRefreshListHeader extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.refresh_list_header, null);
        addView(mContainer, lp);
        setGravity(Gravity.BOTTOM);

        mArrowImageView = (ImageView) findViewById(R.id.refresh_header_arrow);
        mHintTextView = (TextView) findViewById(R.id.tv_refresh_header_hint);
