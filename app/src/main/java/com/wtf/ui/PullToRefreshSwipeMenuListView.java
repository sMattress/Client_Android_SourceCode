...
import com.wtf.R;
import com.wtf.ui.refresh.*;
import com.wtf.ui.swipemenulistview.*;
...
public class PullToRefreshSwipeMenuListView extends ListView implements OnScrollListener {
	...
	private IXListViewLoadListener mListViewLoadListener;
	private IXListViewRefreshListener mListViewRefreshListener;
	...
	private void init(Context context) {
		...
		mHeaderViewContent = (RelativeLayout) mHeaderView.findViewById(R.id.refresh_header_content);
		mHeaderTimeView = (TextView) mHeaderView.findViewById(R.id.refresh_header_time);
	...
	public void showFooterView(boolean enable) {
		if (!enable) {
			mFooterView.hide();
		} else {
			mFooterView.show();
	...
	private void startLoadMore() {
		...
		if (mListViewLoadListener != null) {
			mListViewLoadListener.onLoadMore();
		}
	}
	...
	public void setXListViewRefreshListener(IXListViewRefreshListener l) {
		mListViewRefreshListener = l;
	}

	public void setXListViewLoadListener(IXListViewLoadListener l) {
		mListViewLoadListener = l;
	}
	 ...
	 */
	public interface IXListViewLoadListener {
